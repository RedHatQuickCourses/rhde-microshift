...
--
+
NOTE: if you get errors related to downloading container images, it is probably because you forgot to reboot your _development machine_ after configuring it for acessing the mirror registry.
