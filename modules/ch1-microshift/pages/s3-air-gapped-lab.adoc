...
You now have your _mirror registry machine_ and your _package server machine_ ready to support air-gaped deployment of MicroShift in both package-based RHEL and in RHEL for Edge images.
